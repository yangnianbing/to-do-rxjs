...
module.exports = {
    ...
    filter(array, predicate){
        return this._filter(array, predicate, false);

    },

    remove(array, predicate){
        return this._filter(array, predicate, true);
    },

    _filter(array, predicate, changeOriginal){
        var result = []
    ...
    putHead(array, predicate){
        var head = this.remove(array, predicate);
        head.reverse().forEach(function(item){
            array.unshift(item);
        })
        return array;
    },
...
},{}],"node_modules/@yangnb/jsutil_/DOM.js":[function(require,module,exports) {
module.exports = {
    getParents(elem, className){
        if(!elem){
            return  null;
        }
        ...
        return this.getParents(elem.parentElement, className);
    }
}
},{}],"node_modules/@yangnb/jsutil_/Cache.js":[function(require,module,exports) {
module.exports = {
...
},{}],"node_modules/@yangnb/jsutil_/index.js":[function(require,module,exports) {
module.exports = Object.assign(
    require('./Array'),
    require('./DOM'),
    require('./Cache')
)
},{"./Array":"node_modules/@yangnb/jsutil_/Array.js","./DOM":"node_modules/@yangnb/jsutil_/DOM.js","./Cache":"node_modules/@yangnb/jsutil_/Cache.js"}],"node_modules/snabbdom/vnode.js":[function(require,module,exports) {
"use strict";
...
},{"./vnode":"node_modules/snabbdom/vnode.js","./is":"node_modules/snabbdom/is.js"}],"node_modules/hyperscript-helpers/dist/index.js":[function(require,module,exports) {
'use strict';
...
var _require2 = require('rxjs/operators'),
    startWith = _require2.startWith,
    scan = _require2.scan,
    map = _require2.map,
    merge = _require2.merge,
    combineLatest = _require2.combineLatest,
    pairwise = _require2.pairwise,
    filter = _require2.filter;

var util = require('@yangnb/jsutil_');
...
var _require3 = require('hyperscript-helpers')(h),
    ...
    section = _require3.section;

var snabbdom = require('snabbdom');

var classModule = require('snabbdom/modules/class').default;

var propsModule = require('snabbdom/modules/props').default;

var styleModule = require('snabbdom/modules/style').default;

var attrsModule = require('snabbdom/modules/attributes').default;
...
function intent($container) {
  ...
  var input$ = fromEvent($container, 'keydown').pipe(filter(function (e) {
  ...
  var done$ = source$.pipe(filter(function (e) {
  ...
  var add$ = source$.pipe(filter(function (e) {
  ...
  var remove$ = source$.pipe(filter(function (e) {
  ...
  var top$ = source$.pipe(filter(function (e) {
    return e.target.classList.contains('top');
  }), map(function (e) {
    var rowEl = util.getParents(e.target, 'row');
    return {
      type: 'top',
...
function model(action$) {
  ...
  var doneReducer$ = action$.pipe(filter(function (action) {
    return action.type === 'done';
  }), map(function (action) {
    return function (state) {
      state.records.filter(function (record) {
        return record.id === Number(action.id);
      }).forEach(function (record) {
        return record.done = !record.done;
      });
      return state;
    };
  }));
  var removeReducer$ = action$.pipe(filter(function (action) {
    return action.type === 'remove';
  }), map(function (action) {
    return function (state) {
      util.remove(state.records, function (record) {
        return record.id === Number(action.id);
      });
      return state;
    };
  }));
  var addReducer$ = action$.pipe(filter(function (action) {
  ...
  var topReducer$ = action$.pipe(filter(function (action) {
    return action.type === 'top';
  }), map(function (action) {
    return function (state) {
      util.putHead(state.records, function (record) {
        return record.id === Number(action.id);
      });
      return state;
    };
  }));
  var inputReducer$ = action$.pipe(filter(function (action) {
  ...
  return doneReducer$.pipe(merge(removeReducer$, addReducer$, topReducer$, inputReducer$), scan(function (state, reducer) {
    return reducer(state);
  }, initialState), startWith(initialState));
}

function view(viewState$) {
  return viewState$.pipe(map(function (state) {
    util.setLocalStorageItem('todoCache', state);
    return div('.to-do-container', [section('.header', h2(['待办事项', span('.add', '添加')])), section('.content', ul('.list', state.records.map(renderItem)))]);
  }));
}
...
function renderItem(record) {
  return li('.row', {
    ...
    class: {
      'icon-check': record.done,
      'icon-uncheck': !record.done
    }
  }), input('.content', {
    props: {
      value: record.content
    }
  }), div('.operator', [span('.top.operator-btn.iconfont.icon-zhiding1', {
    attrs: {
      title: '置顶'
    }
  }), span('.remove.operator-btn.iconfont.icon-remove', {
    attrs: {
      title: '删除'
    }
  }), span('.move.operator-btn.iconfont.icon-move', {
    style: {
      cursor: 'move'
    },
    attrs: {
...
main(document.querySelector('.to-do-container')).DOM.pipe(startWith(document.querySelector('.to-do-container')), pairwise()).subscribe(function (_ref) {
...
},{"rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js","@yangnb/jsutil_":"node_modules/@yangnb/jsutil_/index.js","snabbdom/h":"node_modules/snabbdom/h.js","hyperscript-helpers":"node_modules/hyperscript-helpers/dist/index.js","snabbdom":"node_modules/snabbdom/es/snabbdom.js","snabbdom/modules/class":"node_modules/snabbdom/modules/class.js","snabbdom/modules/props":"node_modules/snabbdom/modules/props.js","snabbdom/modules/style":"node_modules/snabbdom/modules/style.js","snabbdom/modules/attributes":"node_modules/snabbdom/modules/attributes.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
